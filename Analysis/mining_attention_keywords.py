...
if __name__ == '__main__':
	draw_word_distribution()
	exit(0)
	# in_original_keywords("a")
	BWH_data = "//cifs2/allergycrico$/Year 1_ RL Solutions NLP Studies/Project 1 - Identifying hypersensitivity reactions/Jie/Data/HSR.BWH.att.trainall.decode.xlsx"
	MGH_data = "//cifs2/allergycrico$/Year 1_ RL Solutions NLP Studies/Project 1 - Identifying hypersensitivity reactions/Jie/Data/HSR.MGH.att.trainall.decode.xlsx"
	average_weight_with_frequency(BWH_data, MGH_data)
	exit(0)
	mining_words_with_large_attention(BWH_data, MGH_data)
	exit(0)

	mining_notes_without_original_keywords(input_data, "decode/HSR.MGH-withoutKeywords.att.trainall.decode.csv")
	# exit(0)
	# mining_words_with_large_attention(input_data)